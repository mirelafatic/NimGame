...
int main(){
    ...
    //font
    sf::Font asper;
    if(!asper.loadFromFile("Aspergit Bold Italic.otf")){
        return -1;
    }
    ...
    //texture
    sf::Texture texture;
    if(!texture.loadFromFile("res/img/nim11.jpg")){
        return -1;
    }
    ...
    sf::Texture texture1;
    if(!texture1.loadFromFile("res/img/nimFirst.jpg")){
        return -1;
    }
    ...
    Button bt4("Game info", {130, 30}, 20, sf::Color{253, 251, 212} , sf::Color::Black);
    bt4.setPosition({330, 300});
    bt4.setFont(asper);
    ...
    text1.setFillColor(sf::Color{253,251,212});
    ...
    textO1.setFillColor(sf::Color{143, 185, 167});
    ...
    text4.setFillColor(sf::Color{143, 185, 167});
    ...
    text5.setFillColor(sf::Color{253,251,212});
    ...
    text12.setFillColor(sf::Color{253,251,212});
    ...
    text7.setFillColor(sf::Color{143, 185, 167});
    ...
    text8.setFillColor(sf::Color{143, 185, 167});
    ...
    text10.setFillColor(sf::Color{143, 185, 167});
    ...
    text11.setFillColor(sf::Color{253,251,212});
    ...
    text13.setFillColor(sf::Color{253,251,212});
